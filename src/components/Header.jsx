      ...
      <div className="flex justify-center items-center gap-2">
        ...
        >
          ...
          <span
            ...
            aria-hidden="true"
          ></span>
          <span className="absolute w-3 h-3 left-0.5 bottom-0.5 bg-white transition-all duration-400 ease-in-out transform peer-checked:translate-x-4 rounded-full"></span>
        </label>
        <p>Dark Mode</p>
      </div>
      <p> |  </p>
